...
import { useRealTimeBalance, useFormattedBalance } from '@/hooks/useRealTimeBalance';
...
export function AvailableBalanceWidget() {
  ...
  const formattedAvailable = useFormattedBalance(balance.availableBalance);
  const formattedTotal = useFormattedBalance(balance.totalBalance);
  const formattedLocked = useFormattedBalance(balance.lockedInTrades);
  const formattedPending = useFormattedBalance(balance.pendingWithdrawal);
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <Card className="p-4 bg-gradient-to-br from-gray-50 to-slate-50 border-gray-200 md:col-span-1">
        ...
        <p className="text-xl font-bold text-gray-900 mt-2">
          ${useFormattedBalance(balance.totalEarnings)}
        </p>
      ...
      <Card className="p-4 bg-gradient-to-br from-amber-50 to-yellow-50 border-amber-200 md:col-span-1">
        ...
        <p className="text-xl font-bold text-amber-900 mt-2">
          ${useFormattedBalance(balance.totalDeposited)}
        </p>
